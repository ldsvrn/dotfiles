...
" | |_| || |    https://www.gitlab.com/dwt1/
" |____/ |_|    
"        
" A customized init.vim for neovim (https://neovim.io/)     

" long live other people's dotfiles
...
"
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" => Vundle For Managing Plugins hello im under the water
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""

call plug#begin('~/.vim/plugged')

"{{ The Basics }}
    Plug 'jiangmiao/auto-pairs'                        " No MS Notepad emulation
...
"{{ Productivity }}
    ...
    Plug 'chrisbra/matchit'                            " Useful for programming
    Plug 'vimwiki/vimwiki'                             " VimWiki 
    Plug 'jreybert/vimagit'                            " Magit-like plugin for vim
"{{ Tim Pope Plugins }}
    Plug 'tpope/vim-surround'                          " Change surrounding marks
"{{ Syntax Highlighting and Colors }}
    Plug 'airblade/vim-gitgutter'                      " show diffs on a git repo
    Plug 'morhetz/gruvbox'                             " Gruvbox theme (le best)
