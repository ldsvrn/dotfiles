...
-- Set up the screenlayout first to fix stupid primary screen issues
-- awful.spawn("/home/louis/.config/screenmain.sh")
...
wallpapermenu = {
    { "next", function() awful.spawn("variety -n") end },
    { "previous", function() awful.spawn("variety -p") end },
    { "fav", function() awful.spawn("variety -f") end }
}

mymainmenu = freedesktop.menu.build({
    before = {
        { "Awesome", myawesomemenu, beautiful.awesome_icon },
        { "Wallpaper", wallpapermenu, beautiful.titlebar_floating_button_normal_active },
        { "Power", computermenu, beautiful.titlebar_close_button_normal }
    },
    after = {
...
-- Set wallpaper to a symlink in .config
beautiful.wallpaper = "/home/louis/.config/wallpaper"
...
globalkeys = gears.table.join(
    ...
    awful.key({ }, "XF86AudioMute",    function () awful.spawn("alacritty --class 'pulsemixer, pulsemixer' -e pulsemixer", { floating = true })     end,
              {description = "launch pulsemixer", group = "launcher"}),
    awful.key({ modkey, "Shift"   }, "g",     function () awful.spawn("caja") end,
              {description = "launch file manager (caja)", group = "launcher"}),
    awful.key({ modkey, "Shift"   }, "a",     function () awful.spawn("anbox launch --package=org.anbox.appmgr --component=org.anbox.appmgr.AppViewActivity") end,
              {description = "anbox appmanager", group = "launcher"}),
...
awful.rules.rules = {
    ...
    { rule_any = {
        ...
        class = {
          ...
          "PacketTracer", -- PT popus are tiled for some reasons
          "Wpa_gui",
          "veromix",
          "xtightvncviewer"},
